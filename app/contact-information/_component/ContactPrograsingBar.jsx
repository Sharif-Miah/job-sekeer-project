  ...
  return (
    <div className='my-5'>
      <div className='flex '>
        ...
        <div className='border-t-4 border-green-500 w-20 mt-[12px]'></div>
        <div className='border-t-4 border-gray-200 w-20 mt-[12px]'></div>
        <div className=' flex justify-center items-center bg-green-500  text-white w-[35px] mt-[-3px] h-[35px] p-3 rounded-full text-sm font-bold'>
          <span>06</span>
        </div>
        <div className='border-t-4 border-gray-200 w-40 mt-[12px]'></div>
        <div className=' flex justify-center items-center bg-green-500  text-white w-[35px] mt-[-3px] h-[35px] p-3 rounded-full text-sm font-bold'>
          <span>07</span>
        </div>
      </div>
      <ul className='flex justify-center items-center gap-10  mt-1'>
        ...
        <li className='list-none text-green-500'>Contact Information</li>
...
export default ContactPrograsingBar;
